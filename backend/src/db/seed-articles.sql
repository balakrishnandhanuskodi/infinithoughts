...
-- Get the issue ID (for articles to reference)
-- Note: Adjust this query if you have a different issue setup
-- For now, we'll let articles reference the first published issue
